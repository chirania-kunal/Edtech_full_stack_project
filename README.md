...
![Main Page](images/mainimage_2.png)
![Main Page](images/mainimage_1.png)
![Main Page](images/mainimage_3.png)



## Project Description

It is a fully functional ed-tech platform that enables users to create, consume,
...
This ed-tech platform consists of three main components: the front end, the
...
Here is a high-level diagram that illustrates the architecture of this ed-tech
platform:
...
It uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of EdTech Platform provides a range of features and functionalities, including:
...
1. Cloud-based media management: It uses Cloudinary, a cloud-based media
...
The back end of EdTech Platform uses a range of frameworks, libraries, and tools to ensure its
...
The back end of EdTech Platform uses a range of data models and database schemas to
...
Overall, the back-end  is designed to provide a robust and scalable solution
...
The EdTech platform's API is designed following the REST architectural style. The
...
In conclusion, the REST API design for the ed-tech platform is a crucial part
...
what kind of data it will accept or return. With this API design, It will be able to
